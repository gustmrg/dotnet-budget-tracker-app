...
namespace BudgetTracker.Web.Controllers
{
    ...
    public class BillsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,TotalDue,DueDate,PaidDate,Status")] Bill bill)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,TotalDue,DueDate,PaidDate,Status")] Bill bill)
        {
            if (id != bill.Id)
            {
                return NotFound();
